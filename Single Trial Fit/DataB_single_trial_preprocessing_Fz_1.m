%% Data B: single-trial preprocessing of Fz IMF5
% This script:
...
inputFile = 'yu20150723b_Task-1.mat';
outputMatFile = 'DataB_Fz_single_trial_preprocessed.mat';
outputCsvFile = 'DataB_Fz_single_trial_peak_summary.csv';
...
%% =========================================================
%  Manually retained Data B trials
%% =========================================================
...
fprintf('Task-1 Data B: total left-cue trials  = %d\n', numberOfLeftCues);
fprintf('Task-1 Data B: total right-cue trials = %d\n', numberOfRightCues);
...
DataB = struct;
DataB.dataset = 'yu20150723b_Task-1';
DataB.channel = 'Fz';
DataB.description = ...
...
DataB.settings = settings;
DataB.cue_locked_time_full = cueLockedTime;
DataB.keepLeft = keepLeft;
DataB.keepRight = keepRight;
DataB.allLeftCueSamples = LeftwardsCue;
DataB.allRightCueSamples = RightwardsCue;
DataB.right = rightTrials;
DataB.left = leftTrials;
DataB.summary = summaryTable;

save(outputMatFile, 'DataB', '-v7.3');
...
function plot_group_imf5_overview( ...
    ...
    set(gcf, ...
        'Color', 'w', ...
        'Name', sprintf('Data B Fz - %s cue IMF5 overview', group.direction), ...
        'NumberTitle', 'off');
    ...
    sgtitle(sprintf( ...
        'Data B Fz single-trial IMF5 quality control: %s cue (%d trials)', ...
        group.direction, ...
        numberOfTrials));
end
...
function plot_positive_fitting_windows( ...
    ...
    set(gcf, ...
        'Color', 'w', ...
        'Name', 'Data B cue-locked positive fitting windows', ...
        'NumberTitle', 'off');
    ...
    sgtitle('Data B cue-locked positive fitting windows');
end
