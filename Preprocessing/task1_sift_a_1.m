...
matFile = 'yu20150723a_Task-1.mat';
...
for i = 1:M2
    ...
    fprintf('Right cue trial %d: Cue = %d, Action = %.0f, RT = %.0f samples, RT = %.3f s\n', ...
...
for i = 1:M1
    ...
    fprintf('Left cue trial %d: Cue = %d, Action = %.0f, RT = %.0f samples, RT = %.3f s\n', ...
